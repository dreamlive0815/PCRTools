...
CHARA_NAME = {
    ...
    1156: ["优衣(仪装束)", "ユイ(儀装束)", "Yui(Costume)", "礼ue", "礼装ue", "礼装优衣", "仪装ue", "礼衣"],
    ...
    1165: ["祈梨(时间旅行)", "イノリ(タイムトラベル)", "Inori(TimeTravel)", "时间旅行龙锤", "穿越龙锤", "穿越梨老八"],
    ...
    1806: ["凯留(公主)", "キャル(プリンセス)", "Karyl(Princess)", "Kyaru(Princess)", "凯露(公主)", "公主黑猫", "公主猫", "公主猫猫头"],
